...
const St1 = ({ stepper, type }) => {
  ...
  const submit = () => {
    ...
    //نام رابط
    const interface_fname = document.getElementById('interface_fname').value
    //نام خانوادگی رابط
    const interface_lname = document.getElementById('interface_lname').value
    //شماره همراه رابط
    const interface_phone_number = document.getElementById('interface_phone_number').value
    //ایمیل
    ...
    <Fragment>
      <Row>
        ...
        <Col xl={4} md={6} className='mt-3'>
          ...
          <Input type='text' id='interface_fname' value={interface_fnameText} onChange={interface_fnameValidator}/>
        </Col>
        <Col xl={4} md={6} className='mt-3'>
          <Label>نام خانوادگی رابط</Label>
          <Input type='text' id='interface_lname'  value={interface_lnameText} onChange={interface_lnameValidator}/>
        </Col>
        <Col xl={4} md={6} className='mt-3'>
          <Label>شماره‌همراه رابط</Label>
          <Input type='text' id='interface_phone_number' value={interface_phone_numberText} onChange={interface_phone_numberValidator}/>
        </Col>
        <Col xl={4} md={6} className='mt-3'>
          <Label>ایمیل</Label>
