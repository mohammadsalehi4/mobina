...
const FuckingGraph = (props) => {
  ...
  const [selectionStart1, SetselectionStart1] = useState({})
  const [selectionEnd1, SetselectionEnd1] = useState({})
  ...
  //     SetEndY(event.clientY - 110)
  //   }
  //   if (showDiv === false) {
  //     SetstartX(event.clientX)
  //     SetstartY(event.clientY - 110)
  //     SetmoveX(event.clientX)
  //     SetmoveY(event.clientY - 110)
  //   }
  //   SetShowDiv(!showDiv)
  // }
