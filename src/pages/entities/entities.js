...
const Entities = () => {
    ...
    return (
        <div className='container-fluid mt-3' id='Entities'>
                    ...
                    <div className='bg-white p-2' style={{borderRadius:"8px", borderStyle:"solid", borderWidth:"2px", borderColor:"rgb(210,210,210)"}}>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-4' style={{textAlign:"left"}}>
                                <button id='entityFilterBotton' color='warning' style={{color:"white", borderRadius:"8px", maxWidth:"100%", background:MainSiteOrange, border:"none", padding:"7px 15px"}}>
