  ...
  return (
    ...
    >
      <Navbar
        expand='lg'
        container={false}
        className={classnames('header-navbar navbar-fixed navbar-shadow navbar-brand-center', {
          'navbar-scrolled': navbarScrolled
        })}
      >
        {!navbar && (
          <div className='navbar-header d-xl-block  flex-row-reverse' id='headerLogo'>
            <ul className='nav navbar-nav  '>
              <NavItem>
                <Link to='/' className='navbar-brand '>
                  <span className='brand-logo mt-1'>
                    <img src={themeConfig.app.appLogoImage} alt='logo' />
                  </span>
                  <h2 className='brand-text mt-1'>{themeConfig.app.appName}</h2>
                </Link>
              </NavItem>
            </ul>
          </div>
